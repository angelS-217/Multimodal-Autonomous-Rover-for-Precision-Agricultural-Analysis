...
class VisionProcessor:
    def __init__(self):
        ...
        self.lower_orange = np.array([5])
        self.upper_orange = np.array([25])
        ...
        if contours:
            ...
            if cv2.contourArea(c) > 300:
                ...
                if M["m00"] > 0:
                    ...
                    # --- Visualization ---
                    # Draw contour around the flag
                    cv2.drawContours(frame, [c], -1, (0, 165, 255), 2) # Orange bounding box
                    # Draw center point of the flag
                    cv2.circle(frame, (target_cx, target_cy), 5, (0, 0, 255), -1)
                    # Draw aiming line from camera center to the flag
